...
SELECT [dbo].[EntidadeAleatoria]('CLIENTE') AS [CLIENTE ALEATÓRIO], [dbo].[EntidadeAleatoria]('PRODUTO') AS [PRODUTO ALEATÓRIO],
[dbo].[EntidadeAleatoria]('VENDEDOR') AS [VENDEDOR ALEATÓRIO]
